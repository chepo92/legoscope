# Reference:h ttp://picamera.readthedocs.io/en/release-1.10/index.html
...
camera.iso = 800    # Retrieves or sets the apparent ISO setting of the camera.
...
#sleep(10)
raw_input('Press enter to take photo and close preview: ')
...
camera.capture('preview.png', 'png')  # use_video_port defaults to False which means that the camera’s image port is used. This port is slow but produces better quality pictures.
e = camera.exposure_speed
print('Shutter Speed: ' + str(e))
